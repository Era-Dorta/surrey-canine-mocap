...
ELSE  ( CMAKE_PKGCONFIG_EXECUTABLE )
	...
	pkg_check_modules(PC_KDL KDL)
	SET(KDL_DEFINITIONS ${PC_KLD_CFLAGS_OTHER})

	FIND_PATH(KDL_INCLUDE_DIR kdl/kdl.hpp)

	FIND_LIBRARY(KDL_LIB orocos-kdl)

	SET(KDL_INCLUDE_DIRS ${KDL_INCLUDE_DIR})
	SET(KDL_LIBS ${KDL_LIB})

	INCLUDE(FindPackageHandleStandardArgs)
	find_package_handle_standard_args(KDL DEFAULT_MSG
		KDL_LIB KDL_INCLUDE_DIR)

	mark_as_advanced(KDL_LIB KDL_INCLUDE_DIR)    

...
bool get_neighbor_white_pixel(cv::Mat& img, int i_row, int i_col, int &res_row,
		int &res_col);
...
bool get_bottom_white_pixel(cv::Mat& img, int &res_row, int &res_col, int i_row,
		int i_col);
...
void cascade_down_right_lower_pixel(const cv::Mat& img, int i_row, int i_col,
		int &res_row, int &res_col);
